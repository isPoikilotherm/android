...
public class SelectManyQuestionByQuestionIdServlet extends HttpServlet{
	private static final long serialVersionUID = 1L;
	
	private List<ManyselectVO> list_mVos;
	private ManyselectBiz manyselectBiz;
	public SelectManyQuestionByQuestionIdServlet(){
		super();  
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		 ...
		 request.setCharacterEncoding("UTF-8");
			response.setCharacterEncoding("UTF-8");
				...
				Integer project_id =Integer.valueOf(request.getParameter("question_id"));
