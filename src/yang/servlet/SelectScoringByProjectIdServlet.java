...
public class SelectScoringByProjectIdServlet extends HttpServlet{
	private static final long serialVersionUID = 1L;
	
	private List<ScoringVO> list_sVos;
	private ScoringBiz scoringBiz;
	public SelectScoringByProjectIdServlet() {
		super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		 ...
		 request.setCharacterEncoding("UTF-8");
			response.setCharacterEncoding("UTF-8");
				...
				list_sVos=scoringBiz.SelectByProjectId(project_id);	
